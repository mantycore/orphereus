...
<table width="80%" class="hlTable" align="center">
    ...
    <tr>
        ...
        <tr>
            ...
            <br/>
            <a href="#syntax">Поддерживаемые языки</a>
            </td>
        </tr>
  </tbody>
</table>
...
<a name="search"></a>
<p>Если поисковый запрос содержит знак двоеточия, то стоящий до двоеточия текст
рассматривается как фильтр, внутри которого должен происходить поиск (уточняющий фильтр).
Например, если в поле поиска вписать <i>b+d:поисковый_запрос</i>, то будут найдены
все посты, удовлетворяющие "<i>поисковому_запросу</i>" из досок <b>/b/</b> и <b>/d/</b><br/>
В противном случае осуществляется поиск всех постов, удовлетворяющих запросу.
Различий между скрытыми и обычными досками, а также скрытыми и обычными тредами не делается.
(Если вас интересует поиск в овервью, используйте запрос вида <i>~:поисковый_запрос</i>)</p>

<%include file="${'wakaba.%s.mako' % g.pluginsDict[g.OPT.searchPluginId].helpTemplateName()}" />

<h3 style="text-align: center;">Мазня (Oekaki)</h3>
<a name="oekaki"></a>
Если вы хотите дорисовать чью-то картинку, используя отличные от указанных в профиле настройки,
...
<table width="40%" align="center">
    ...
    <tbody>
      <tr>
      <td align="left">lua</td><td align="left">Lua</td>
      <td align="left">perl</td><td align="left">Perl</td>
      </tr>
      <tr>
      <td align="left">python</td><td align="left">Python</td>
      <td align="left">python3</td><td align="left">Python 3000</td>
      </tr>
      <tr>
      <td align="left">ruby</td><td align="left">Ruby</td>
      <td align="left">tcl</td><td align="left">TCL</td>
      </tr>
      <tr>
      <td align="left">c</td><td align="left">C</td>
      <td align="left">cpp</td><td align="left">C++</td>
      </tr>
      <tr>
      <td align="left">d</td><td align="left">D</td>
      <td align="left">delphi</td><td align="left">Delphi</td>
      </tr>
      <tr>
      <td align="left">fortran</td><td align="left">Fortran</td>
      <td align="left">java</td><td align="left">Java</td>
      </tr>
      <tr>
      <td align="left">objectivec</td><td align="left">Objective C</td>
      <td align="left">scala</td><td align="left">Scala</td>
      </tr>
      <tr>
      <td align="left">csharp</td><td align="left">C#</td>
      <td align="left">vbnet</td><td align="left">VB.Net</td>
      </tr>
      <tr>
      <td align="left">clisp</td><td align="left">Common LISP</td>
      <td align="left">erlang</td><td align="left">Erlang</td>
      </tr>
      <tr>
      <td align="left">haskell</td><td align="left">Haskell</td>
      <td align="left">ocaml</td><td align="left">Ocaml</td>
      </tr>
      <tr>
      <td align="left">scheme</td><td align="left">Scheme</td>
      <td align="left">bash</td><td align="left">Bash</td>
      </tr>
      <tr>
      <td align="left">mysql</td><td align="left">MySQL</td>
      <td align="left">sql</td><td align="left">SQL</td>
      </tr>
      <tr>
      <td align="left">ini</td><td align="left">Ini files</td>
      <td align="left">tex</td><td align="left">Tex</td>
      </tr>
      <tr>
      <td align="left">html</td><td align="left">HTML</td>
      <td align="left">js</td><td align="left">JavaScript</td>
      </tr>
      <tr>
      <td align="left">php</td><td align="left">PHP</td>
      <td align="left">xml</td><td align="left">XML</td>
      </tr>
    </tbody>
</table>
