...
Некоторые из них вы видите наверху страницы — это т.н. фиксированные доски. Любой популярный тэг может стать доской.
...
<br/>
Также на Аноме есть три специальных фильтра:
<ol>
<li><b>/~/</b> — все треды изо всех досок. В своем <a href="/userProfile/">профиле</a> вы можете перечислить через запятую те тэги, которые вы не хотите видеть в /~/</li>
<li><b>/@/</b> — все треды, в которых есть ваши сообщения</li>
<li><b>/!/</b> — главная страница - список досок и тэгов, статистическая информация и прочее.</li>
</ol>
Вы можете добавить часто используемые фильтры в свой профиль - тогда под списком досок появится еще одна строка с вашими личными фильтрами.
<hr />