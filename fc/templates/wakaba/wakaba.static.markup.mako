...
IP адреса пользователей нигде не хранятся.
...
<ol>
<li><b>+</b> — объединение множеств. A+B выдает все посты из /A/, /B/ и размещенные на обоих досках</li>
<li><b>-</b> — вычитание множеств. A-B выдает все посты из A, которые <i>не</i> являются кросспостами в B</li>
<li><b>&</b> — пересечение множеств. A&B выдает все посты из A, которые являются кросспостами в B</li>
</ol>
