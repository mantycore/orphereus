...
<%include file="noema.paginator.mako" args="routeName='search', kwargDict={'text' : c.query}"/>
...
<table id="quickReplyNode${pt.id}">
    <tbody>
        ...
        &nbsp;
        <%include file="noema.fileBlock.mako" args="post=pt,opPost=None,searchMode=True,newsMode=None" />
...
<%include file="noema.jsService.mako" />
