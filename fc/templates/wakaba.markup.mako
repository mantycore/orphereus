...
Вы можете добавить часто используемые фильтры в свой профиль (пункт User Filters) - тогда под списком досок появится еще одна строка с вашими личными фильтрами.
<hr />